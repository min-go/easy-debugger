...
defineProps<{ name: string; size?: 'sm' }>();
const paths: Record<string, string> = {
  ...
  sessions: '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M7 10h4M7 14h8"/>',
  ...
  snippets: '<path d="M8 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2"/><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M9 12h6M9 16h4"/>',
  ...
  logo: '<path d="M4 12h4l2-6 4 12 2-6h4"/>',
  refresh: '<path d="M21 12a9 9 0 1 1-2.6-6.4M21 3v6h-6"/>',
  power: '<path d="M12 3v9M18.4 6.6a9 9 0 1 1-12.8 0"/>',
  kick: '<path d="M16 17l5-5-5-5M21 12H9M13 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8"/>',
...
<template>
  <svg :class="['icon', size]" viewBox="0 0 24 24" v-html="paths[name] ?? ''"></svg>
</template>
